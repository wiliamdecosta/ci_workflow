...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Form Verifikasi Cuti</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
    ...
    <div class="col-xs-12">
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Form Verifikasi Cuti </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form id="form-verifikasi" method="post" name="form-verifikasi" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" required="" name="verified_by" id="verified_by" value="<?php echo $verifikator; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">NIP Verifikator</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" required="" name="verified_nip" id="verified_nip" value="<?php echo $row['verified_nip'];?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Catatan Verifikator</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="verified_notes" id="verified_notes" value="<?php echo $row['verified_notes'];?>">
                            </div>
                        </div>
                    ...
                    <div class="form-actions bottom">
                        <div class="row">
                            ...
                            <div class="col-md-offset-3 col-md-4">
                                ...
                                <button type="button" class="btn btn-warning" onClick="onSubmitWF();">Submit</button>
                            </div>  
                            <?php endif; ?>                        
                        </div>
                    </div>
...
<script>
    ...
    $('#form-verifikasi').on('submit', function(e){
        ...
        var items = JSON.stringify(object);
        updateForm(items);
    ...
    function updateForm(items) {
        $.ajax({
            type: 'POST',
            datatype: "json",
            url: '<?php echo WS_JQGRID."transaksi.t_registrasi_cuti_controller/update"; ?>',
            data: {items: items},
            success: function(response) {
                if(response.success == false) {
                    swal('Informasi',response.message,'warning');
                }else {
                    swal('Informasi',response.message,'success');
                }
            }
        });
    }
