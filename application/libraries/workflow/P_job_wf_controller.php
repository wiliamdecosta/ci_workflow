...
class P_job_wf_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','job_wf_id');
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','job_wf_id');
        ...
        try {
            ...
            if(!empty($searchPhrase)) {
                $table->setCriteria("(upper(job_wf_name) like upper('%".$searchPhrase."%') OR upper(f_after_submit) like upper('%".$searchPhrase."%'))");
            }
