...
/**
* Json library
* @class P_document_type_controller
...
class P_document_type_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('workflow/p_document_type');
            $table = $ci->p_document_type;
    ...
    function readLov() {
        ...
        try {
            ...
            if(!empty($searchPhrase)) {
                $table->setCriteria("(upper(document_name) like upper('%".$searchPhrase."%') OR upper(description) like upper('%".$searchPhrase."%'))");
            }
